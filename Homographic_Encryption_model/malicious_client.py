...
def init():
    ...
    data = {'subject':'handshake',  'node_address':'http://127.0.0.1:5000',  'model':model}
...
def train():
    ...
    data_byte = pickle.dumps(data)
    print("length of data_byte",len(data_byte))
    return data_byte
