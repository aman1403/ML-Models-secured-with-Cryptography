...
#------------------------------------------------------------------------------------------------------------------------------------------------------
# Data Distribution and Model Initialization 

df = pandas.read_csv('data.csv')
data = df[int(len(df)/10):int((2*len(df))/10)]
...
# Data Distribution and Model Initialization Completed
#------------------------------------------------------------------------------------------------------------------------------------------------------
...
#------------------------------------------------------------------------------------------------------------------------------------------------------
# serializing(Encrypting) the Parameters 
...
# serializing(Encrypting)  Parameters ends 
#------------------------------------------------------------------------------------------------------------------------------------------------------
...
#------------------------------------------------------------------------------------------------------------------------------------------------------
# deserializing(Encrypting) the Parameters 
...
# deserializing(Encrypting) the Parameters ends
#------------------------------------------------------------------------------------------------------------------------------------------------------



#  Assigning and training Weights to the Parameters 
#------------------------------------------------------------------------------------------------------------------------------------------------------
...
#  Assigning and training Weights to the Parameters ends
#------------------------------------------------------------------------------------------------------------------------------------------------------
...
def init():
    ...
    data = {'subject':'handshake',  'node_address':'http://127.0.0.1:5001',  'model':model}
...
#  Handshake with the server ends
#------------------------------------------------------------------------------------------------------------------------------------------------------




#  Sending and receiving Weights Parameters from Server
#------------------------------------------------------------------------------------------------------------------------------------------------------
...
#  Sending and receiving Weights Parameters from Server ends
#------------------------------------------------------------------------------------------------------------------------------------------------------