...
data = df[int((2*len(df))/10):int((3*len(df))/10)]
print(len(data))
...
def init():
    ...
    data = {'subject':'handshake',  'node_address':'http://127.0.0.1:5002',  'model':model}
